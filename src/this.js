...
class User {
  ...
  checkPassword(passwordFromKeyBoard) {
...
// console.log(result); //works, tis true
...
// read http://www.digital-web.com/articles/scope_in_javascript/   on this, call apply and bind
// .call
console.log(checkPassword.call(me, 'correcthorsebatterystaple'));
// .apply
console.log(checkPassword.apply(me, ['correcthorsebatterystaple1']));
// .bind
const check = checkPassword.call(me, 'correcthorsebatterystaple'); // bind does not invoke the function , see articles
console.log(check);
